...
| `showLockedProTools` | `bool` | `false` | Whether tools above the running edition stay listed (marked `[Pro]`, answering any call with an upgrade message) instead of being hidden. See [Editions](editions.md) |
